"""Diverse opening positions for benchmarking.

20 standard openings to reduce variance in engine matches.
Each position is a FEN after a few moves of a well-known opening.
"""
